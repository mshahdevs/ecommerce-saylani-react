...
import { CiShoppingCart, CiZoomIn } from 'react-icons/ci';
...
export const Favorite = () => {
  ...
  return (
    <div className=' p-2 w-full flex font-josefin flex-col space-y-4 justify-center items-center m-auto'>
      {favoriteProducts.map((product) => (
        <div className='bg-white rounded-md shadow-lg mb-4 shadow-fuchsia-200 p-5 w-[80%] gap-6 flex justify-evenly items-center'>
          ...
          <div className=' flex flex-col justify-start gap-4 items-start'>
            <div className='flex justify-start items-center gap-3'>
              <h1 className='font-medium text-left'>{product?.title}</h1>
