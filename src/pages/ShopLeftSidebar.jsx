...
export const ShopLeftSidebar = () => {
  ...
  const handleCategory = (event) =>{
    ...
    dispatch(setCategory(isChecked ? "Clothes": ""))
    ...
    <>
      ...
      <div className="w-[84%] flex my-4 mx-auto ">
        ...
        <div className="flex flex-col justify-start items-start">
            <h1 className="underline leading-7 font-semibold font-josefin">
              Categories
            </h1>
            <div className="flex items-center space-x-2">
              <input type="checkbox" onChange={handleCategory} className="custom-checkbox" name="" id="clothes" />
              <label htmlFor="clothes" className="">
                Clothes
              </label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" className="custom-checkbox"  name="" id="fusion" />
              <label htmlFor="fusion">Magento</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" className="custom-checkbox" name="" id="unique" />
              <label htmlFor="unique">Bigcommerce</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" className="custom-checkbox" name="" id="dream" />
              <label htmlFor="dream">osCommerce</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" className="custom-checkbox" name="" id="young" />
              <label htmlFor="young">3dcart</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" className="custom-checkbox" name="" id="green" />
              <label htmlFor="green">
                Bags
        ...
        <div className="w-[90%] py-3">
          {filterProducts?.map((product,index) => (
            <div key={index} className="w-full my-4  mx-auto">
