    ...
    <>
      ...
      <div className='flex justify-center flex-col font-poppins p-8  items-center mx-auto w-full'>
        <form className='w-1/3  flex gap-1 flex-col p-8 bg-white rounded-md shadow-custom '>
          {isSignInActive ? (
            <span className='mb-3 font-josefin font-bold'>Sign Up</span>
          ) : (
            <span className='mb-3 font-bold font-josefin'>Login</span>
          )}
          {isSignInActive ? (
          ...
          <div className='relative gap-2 flex flex-col'>
            ...
            <div className='flex'>
              <span
                ...
                className='text-[14px] text-[#9096B2]'
              >
                {isSignInActive ? (
                  <span className='h-10 invisible'>d</span>
                ) : (
